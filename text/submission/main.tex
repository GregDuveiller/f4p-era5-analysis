...
of the spectrum, defined for this product as ranging from 0.4 to 0.7 \selectlanguage{greek}µ\selectlanguage{english}m. This means some slight discrepancy with ERA5 might occur for
ultraviolet light over the 0.3 to 0.4 \selectlanguage{greek}µ\selectlanguage{english}m range, but this is expected to be very marginal due to the low contribution of UV light to ecosystem
...
transpiration more than ERA5-Land~\citep{Munoz_Sabater_2021}. Therefore, the discrepancy in HW18a may require more investigation based on other
reference sources.
...
\codedataavailability{The code necessary to reproduce this analysis is available in a Zenodo repository: https://doi.org/10.5281/zenodo.7275088. The input data for this work is available in another dedicated Zenodo repository: https://doi.org/10.5281/zenodo.6976942} %% use this section when having data sets and software code available
