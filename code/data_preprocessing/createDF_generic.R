...
var <- 'albedo_ERA5l_025'             # 025 and 01 # ET_GLEAM SM_ERA5l SM_sat SM_ERA5l_01_2009.nc LAI_theia_01_1998.nc
root_data   <- '/mnt/cidstorage/cidportal/data/cid-bulk22/Shared/projectData/COPERNICUSII/data/CDS_data/albedo_ERA5land/data/nc_for_df/'
output_path <- '/mnt/cidstorage/cidportal/data/cid-bulk22/Shared/projectData/COPERNICUSII/data/CDS_data/albedo_ERA5land/data/dataframe/'
#script_info <-'albedo_GEE'                 # 
start_year <- 2014 ; end_year <- 2014 #18      # just hardcode year range for now
