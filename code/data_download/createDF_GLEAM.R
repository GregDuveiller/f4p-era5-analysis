  # original name : createDF_generic.R
#
# ########################################################
# Title         : 
...
var <- 'ET_GLEAM_01'        #ET and E     # 025 and 01 # ET_GLEAM SM_ERA5l SM_sat SM_ERA5l_01_2009.nc LAI_theia_01_1998.nc
root_data   <- '/mnt/cidstorage/cidportal/data/cid-bulk22/Shared/projectData/COPERNICUSII/data/GLEAM/data/nc_for_df/'
output_path <- '/mnt/cidstorage/cidportal/data/cid-bulk22/Shared/projectData/COPERNICUSII/data/GLEAM/data/dataframe/'
...
sf <- list( E_GLEAM = 1, ET_GLEAM = 1, ET_ERA5l = -1000,  SM_sat = 1, SM_ERA5l = 1, SM_ERA5l = 1, LAI_theia = 1, LAI_ERA5sl = 1, albedo_GEE = 100000, albedo_ERA5l = 1 ) # 
